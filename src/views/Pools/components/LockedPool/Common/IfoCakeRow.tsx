...
const IfoCakeRow: React.FC = () => {
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <Box>
      <Text>
        {t(
          'The number of iMEGG equals the locked staking amount if the staking duration is longer than %weeks% weeks. If the staking duration is less than %weeks% weeks, it will linearly decrease based on the staking duration.',
          {
            weeks: weeksDisplay,
          },
        )}
      </Text>
      <InlineLink external href="https://docs.metaegg.io/imegg">
        {t('Learn more about iMEGG')}
      </InlineLink>
    </Box>,
    {
